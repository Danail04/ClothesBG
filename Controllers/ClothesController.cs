...
namespace ClothesBG.Controllers
{
    public class ClothesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Name,Price,ImageUrl")] Clothes clothes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Name,Price,ImageUrl")] Clothes clothes)
        {
            if (id != clothes.Id)
            {
                return NotFound();
